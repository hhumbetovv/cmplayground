...
/**
 * Each `Text` and the switch read their own field, so completing the task repaints the status row
 * and leaves the title alone — the header itself never recomposes.
 */
@Composable
